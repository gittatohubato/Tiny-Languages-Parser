...
public final class BinarySearchTree extends BinaryTreeBasis {
	 ...
	 * @param newCircle
	 */
	public void insertItem(Circle newCircle, String direction) {
		root = insertItem(root, newCircle, direction);
	}
	 ...
	 * @Overload insertItem() 
	 */
	protected TreeNode insertItem(TreeNode tNode, Circle newCircle, String direction) {
		TreeNode newSubtree;
		
		if (tNode == null) {
			tNode = new TreeNode(newCircle, null, null, null, null);
			return tNode;
		}
		
		Circle nodeItem = tNode.root;

		/*if(Objects.equals(newCircle.getSearchKey(), nodeItem.getSearchKey())) {
		    return tNode;
        }*/

		/*if (newCircle.getSearchKey() < 0) {
			newSubtree = insertItem(tNode.centerCircle, newCircle);
			tNode.centerCircle = newSubtree;
			return tNode;
		}
		...
		if (direction.equals("LEFT")) {
			newSubtree = insertItem(tNode.leftChild, newCircle, direction);
			tNode.leftChild = newSubtree;
			return tNode;
		}

		newSubtree = insertItem(tNode.rightChild, newCircle, direction);
	...
	*//**
	...
	public void setRootItem(Circle newItem) {
		root = new TreeNode(newItem, null, null, null, null);
	}
}
